...
let%expect_test "NOP" =
  ...
  [%expect {|
    { Cpu.registers =
      ...
      pc = 0x0002; sp = 0x0000; mmu = <opaque>; halted = false } |}]
...
let%expect_test "LD HL, SP+0x03" =
  ...
  [%expect{|
    { Cpu.registers =
      ...
      pc = 0x0002; sp = 0x1234; mmu = <opaque>; halted = false } |}]
...
let%expect_test "LD SP, 0xABCD" =
  ...
  [%expect{|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0x00; c = 0x00; d = 0x00; e = 0x00;
        f = (c=0, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0x0002; sp = 0xabcd; mmu = <opaque>; halted = false } |}]
  ...
  [%expect {|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0xbb; c = 0xcc; d = 0x00; e = 0x00;
        f = (c=0, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0x0002; sp = 0x0006; mmu = <opaque>; halted = false } |}];
...
let%expect_test "POP BC" =
  ...
  [%expect {|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0xbb; c = 0xcc; d = 0x00; e = 0x00;
        f = (c=0, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0x0002; sp = 0x0008; mmu = <opaque>; halted = false } |}]
...
let%expect_test "JP 0x10" =
  ...
  [%expect {|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0x00; c = 0x00; d = 0x00; e = 0x00;
        f = (c=0, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0x0010; sp = 0x0000; mmu = <opaque>; halted = false } |}]
...
let%expect_test "JP (HL)" =
  ...
  [%expect {|
    { Cpu.registers =
      ...
      pc = 0xaabb; sp = 0x0000; mmu = <opaque>; halted = false } |}]
...
let%expect_test "JR NC, 0x0e when c=1" =
  ...
  [%expect {|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0x00; c = 0x00; d = 0x00; e = 0x00;
        f = (c=1, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0x0004; sp = 0x0000; mmu = <opaque>; halted = false } |}]
...
let%expect_test "CALL 0x10" =
  ...
  [%expect {|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0x00; c = 0x00; d = 0x00; e = 0x00;
        f = (c=0, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0x0010; sp = 0x0006; mmu = <opaque>; halted = false } |}];
...
let%expect_test "RET" =
  ...
  [%expect {|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0x00; c = 0x00; d = 0x00; e = 0x00;
        f = (c=0, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0xbbcc; sp = 0x0008; mmu = <opaque>; halted = false } |}]
...
let%expect_test "RST 0x08" =
  ...
  [%expect {|
    { Cpu.registers =
      { Registers.a = 0x00; b = 0x00; c = 0x00; d = 0x00; e = 0x00;
        f = (c=0, h=0, n=0, z=0); h = 0x00; l = 0x00 };
      pc = 0x0008; sp = 0x0006; mmu = <opaque>; halted = false } |}];
