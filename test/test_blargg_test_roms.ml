...
let%expect_test "11-op a,(hl).gb" =
  ...
  [%expect {|
    ...
    5B B6 37
    Failed |}]
(*  A:$12 F:---- BC:$5691 DE:$9ABC HL:$0000 SP:$0100 PC:$C63F | JP $DEF8
 * -A:$12 F:---- BC:$5691 DE:$9ABC HL:$0000 SP:$0100 PC:$DEF8 | ADD SP, 1
 * -A:$12 F:---- BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$DEFA | NOP
 * -A:$12 F:---- BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$DEFB | JP $C642
 * -A:$12 F:---- BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$C642 | LD ($DD02), SP
 * -A:$12 F:---- BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$C645 | LD SP, $DF70
 ...
 * -A:$33 F:---- BC:$5691 DE:$9ABC HL:$0012 SP:$DF6A PC:$C514 | XOR A, L
 * +A:$12 F:---- BC:$5691 DE:$9ABC HL:$0000 SP:$0100 PC:$DEF8 | ADD SP, $01
 * +A:$12 F:---C BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$DEFA | NOP
 * +A:$12 F:---C BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$DEFB | JP $C642
 * +A:$12 F:---C BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$C642 | LD ($DD02), SP
 * +A:$12 F:---C BC:$5691 DE:$9ABC HL:$0000 SP:$0101 PC:$C645 | LD SP, $DF70
