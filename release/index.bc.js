...
(function(joo_global_object)
   {"use strict";
    ...
    var
     ...
     _wa_=[0,0],
     _wb_=[0,1],
     _wc_=[0,caml_string_of_jsbytes("lib/cpu/cpu.ml"),280,16],
     _wd_=[0,0],
     _we_=[0,0],
     _wf_=[0,0],
     _wg_=[0,0],
                  ...
                  if(_A7_)
                   ...
                   {var _A8_=accepts$7(t[6],addr);
                    if(_A8_)
                     ...
                     {var _A9_=accepts$9(t[7],addr);
                      if(_A9_)
                       var _A3_=_A9_;
                      else
                       {var _A__=accepts$11(t[8],addr);
                 ...
                 {if(_xS_(t[1],addr))return _xU_(t[1],addr);
                  ...
                  if(accepts$13(t[4],addr))
                   {var _AA_=t[4];
                    ...
                    if(accepts$9(_AA_[7],addr))
                     {var _Ax_=_AA_[7];
                      if(accepts$9(_Ax_,addr))
                       {switch(_Ax_[7])
                    ...
                    if(accepts$11(_AA_[8],addr))
                     {var _Ay_=_AA_[8];
                      if(accepts$11(_Ay_,addr))
                       return byte_of_bitflags
                               (_Ay_[2],
                                1 === _Ay_[3]?1:0,
                                _Ay_[4],
                  ...
                  if(accepts$13(t[4],addr))
                   {var _z4_=t[4];
                    ...
                    if(accepts$8(_z4_[3],addr))
                     {var match$5=_z4_[7][7];
                      return 2 <= match$5?write_byte$2(_z4_[3],addr,data):0}
                    ...
                    if(accepts$9(_z4_[7],addr))
                     {var _zY_=_z4_[7];
                      if(accepts$9(_zY_,addr))
                       {var
                         match$0=bitflags_of_byte(data),
                         b3=match$0[5],
                         b4=match$0[4],
                    ...
                    if(accepts$11(_z4_[8],addr))
                     {var lcd_enable_before=_z4_[8][2],_zZ_=_z4_[8];
                      if(accepts$11(_zZ_,addr))
                       {var
                     ...
                     {var _y__=t[1];
                      ...
                      if(_y__[6])
                       ...
                       {var
                        ...
                        _y__[4] = caml_call2(symbol$3,_y__[4],len$1);
                        var
                         _y5_=mcycles[1],
                         _y6_=mcycles[2],
                         _ym_=_y__[1],
                             ...
                             {if(typeof arg === "number")
                               switch(arg)
                                {case 0:
                                  ...
                                  return read_byte$2(_zi_[2],addr);
                                 case 1:
                                  var addr$0=read_rr(_zi_[1],3),_zj_=succ$0(addr$0);
                                  write_rr(_zi_[1],3,_zj_);
                                  return read_byte$2(_zi_[2],addr$0);
                                 case 2:
                                  var addr$1=read_rr(_zi_[1],3),_zk_=pred$0(addr$1);
                                  write_rr(_zi_[1],3,_zk_);
                                  return read_byte$2(_zi_[2],addr$1);
                                 default:return _zi_[5]}
                              else
                               switch(arg[0])
                                {case 0:var n=arg[1];return n;
                                 case 1:var n$0=arg[1];return n$0;
                                 case 2:var addr$2=arg[1];return read_byte$2(_zi_[2],addr$2);
                                 case 3:var addr$3=arg[1];return read_word(_zi_[2],addr$3);
                                 ...
                                 case 6:
                                  ...
                                  return read_byte$2(_zi_[2],addr$4);
                                 case 7:
                                  var
                                   n$1=arg[1],
                                   addr$5=caml_call2(symbol$3,65280,n$1 & 65535);
                                  return read_byte$2(_zi_[2],addr$5);
                                 default:
                                  var n$2=arg[1],_zl_=_zi_[5],n$3=to_int(n$2);
                                  set_flags
                               ...
                               switch(x)
                                {case 0:
                                  var
                                   c=read_r(_zf_[1],2),
                                   addr=caml_call2(symbol$3,65280,c & 65535);
                                  return write_byte$3(_zf_[2],addr,y);
                                 case 1:
                                  var addr$0=read_rr(_zf_[1],3);
                                  write_byte$3(_zf_[2],addr$0,y);
                                  var _zg_=succ$0(addr$0);
                                  return write_rr(_zf_[1],3,_zg_);
                                 case 2:
                                  var addr$1=read_rr(_zf_[1],3);
                                  write_byte$3(_zf_[2],addr$1,y);
                                  var _zh_=pred$0(addr$1);
                                  return write_rr(_zf_[1],3,_zh_);
                                 default:_zf_[5] = y;return 0}
                              else
                               switch(x[0])
                                {case 2:
                                  var addr$2=x[1];return write_byte$3(_zf_[2],addr$2,y);
                                 case 3:var addr$3=x[1];return write_word(_zf_[2],addr$3,y);
                                 ...
                                 case 6:
                                  ...
                                  return write_byte$3(_zf_[2],addr$4,y);
                                 case 7:
                                  var n=x[1],addr$5=caml_call2(symbol$3,65280,n & 65535);
                                  return write_byte$3(_zf_[2],addr$5,y);
                        ...
                        if(typeof inst === "number")
                         switch(inst)
                          {case 0:
                           ...
                           case 5:_y__[6] = 1;var next_pc=0;break;
                           case 6:throw [0,Assert_failure,_wc_];
                           case 7:_y__[8] = 0;_y__[7] = 0;var next_pc=0;break;
                           case 8:_y__[8] = 1;var next_pc=0;break;
                           case 9:
                            var
                             a$0=read_r(_y__[1],0),
                           ...
                           case 12:
                            ...
                            break;
                           default:
                            var addr$0=read_word(_y__[2],_y__[5]);
                            _y__[5] = caml_call2(symbol$3,_y__[5],2);
                            _y__[7] = 1;
                         ...
                         switch(inst[0])
                          {case 0:
                           ...
                           case 27:
                            var rr=inst[1];
                            _y__[5] = caml_call2(symbol$4,_y__[5],2);
                            var _yW_=read_rr(_y__[1],rr);
                            write_word(_y__[2],_y__[5],_yW_);
                            var next_pc=0;
                            break;
                           case 28:
                            var rr$0=inst[1],_yX_=read_word(_y__[2],_y__[5]);
                            ...
                            var
                             ...
                             _y1_=
                              check_condition(_y__,c$8)
                               ?(_y__[5]
                                 =
                                 caml_call2(symbol$4,_y__[5],2),
                                 write_word(_y__[2],_y__[5],_y__[4]),
                                 [0,x$45])
                               :0,
                             next_pc=_y1_;
                            break;
                           ...
                           default:
                            ...
                            if(check_condition(_y__,c$9))
                             {var addr$2=read_word(_y__[2],_y__[5]);
                              _y__[5] = caml_call2(symbol$3,_y__[5],2);
                              var _y2_=[0,addr$2]}
                            else
                             var _y2_=0;
                        ...
                        _y__[9] = inst;
                        if(next_pc)
                         {var addr=next_pc[1];_y__[4] = addr;var _y7_=_y6_}
                        else
                         var _y7_=_y5_;
                        var inst_mcycles=_y7_}
                      var _y8_=_y__[3],switch$0=0;
