      ...
      var
       ...
       read_rr=
        function(t,rr)
         {switch(rr)
           {case 0:
             var _wE_=t[6] & 65535;
             return caml_call2(lor$0,caml_call2(lsl$0,t[1] & 65535,8),_wE_);
            case 1:
             var _wF_=t[3] & 65535;
             return caml_call2(lor$0,caml_call2(lsl$0,t[2] & 65535,8),_wF_);
            case 2:
             var _wG_=t[5] & 65535;
             return caml_call2(lor$0,caml_call2(lsl$0,t[4] & 65535,8),_wG_);
            default:
             var _wH_=t[8] & 65535;
             return caml_call2(lor$0,caml_call2(lsl$0,t[7] & 65535,8),_wH_)}},
       write_r=
        function(t,r,x)
         {switch(r)
       ...
       read_flag=
        function(t,flag)
         {var _wD_=t[6];
          switch(flag)
           {case 0:return 0 !== (_wD_ & 16)?1:0;
            case 1:return 0 !== (_wD_ & 32)?1:0;
            case 2:return 0 !== (_wD_ & 64)?1:0;
            default:return 0 !== (_wD_ & 128)?1:0}},
       mask_0b00010000=16,
       mask_0b11100000=224,
       mask_0b00100000=32,
       mask_0b11010000=208,
       ...
       mask_0b01110000=112,
       set_flags=
        function(t,opt,_wC_,_wB_,_wA_,param)
         {if(opt)var sth=opt[1],c=sth;else var c=read_flag(t,0);
          if(_wC_)var sth$0=_wC_[1],h=sth$0;else var h=read_flag(t,1);
          if(_wB_)var sth$1=_wB_[1],n=sth$1;else var n=read_flag(t,2);
          if(_wA_)var sth$2=_wA_[1],z=sth$2;else var z=read_flag(t,3);
          t[6]
          =
          c
       ...
       read_byte$1=
        function(t,addr)
         {function bits_of_color(param)
          ...
          if(accepts$7(t,addr))
           {var
             _wx_=bits_of_color(t[5]) << 6,
             _wy_=bits_of_color(t[4]) << 4,
             _wz_=bits_of_color(t[3]) << 2;
            return (bits_of_color(t[2]) | _wz_ | _wy_ | _wx_) & 255}
       ...
       accepts$10=
        function(t,addr)
         {var
          ...
          for(;;)
           {if(param)
             {var l=param[2],a=param[1],_wn_=caml_call2(symbol$5,addr,a);
              if(_wn_)return _wn_;
              var param=l;
              continue}
            return 0}},
       register_of_addr=
        function(t,addr)
         {if(caml_call2(symbol$5,addr,t[1][1]))return t[1];
          ...
          var _wm_=caml_call1(show$0,addr);
          throw [0,Invalid_argument,caml_call1(sprintf(_ch_),_wm_)]},
       ...
       handle_ly_eq_lyc=
        function(t)
         {var ly=get_ly(t[9]),b=ly === t[9][4][2]?1:0;
          t[7][6] = b;
          var _wl_=b?is_enabled(t[7],0):b;
          return _wl_?request(t[10],1):_wl_},
       screen_w=160,
       screen_h=144,
       accepts$13=
        function(t,addr)
         {var _wc_=accepts$1(t[2],addr);
          if(_wc_)
           var _wd_=_wc_;
          else
           {var _we_=accepts$2(t[1],addr);
            if(_we_)
             var _wd_=_we_;
            else
             {var _wf_=accepts$8(t[3],addr);
              if(_wf_)
               var _wd_=_wf_;
              else
               {var _wg_=accepts$7(t[4],addr);
                if(_wg_)
                 var _wd_=_wg_;
                else
                 {var _wh_=accepts$7(t[5],addr);
                  if(_wh_)
                   var _wd_=_wh_;
                  else
                   {var _wi_=accepts$7(t[6],addr);
                    if(_wi_)
                     var _wd_=_wi_;
                    else
                     {var _wj_=accepts$9(t[7],addr);
                      if(_wj_)
                       var _wd_=_wj_;
                      else
                       {var _wk_=accepts$11(t[8],addr);
                        if(! _wk_)return accepts$10(t[9],addr);
                        var _wd_=_wk_}}}}}}}
          return _wd_},
       create$3=
        function(rom_bytes)
       ...
       ram_addr_of_addr=
        function(t,addr)
         {var _wb_=t[4];
          if(t[8] && 1 !== _wb_)
           {if(4 === _wb_)return (8192 * t[7] | 0) + (addr - 40960 | 0) | 0;
            throw [0,Invalid_argument,caml_call1(sprintf(_rE_),_wb_)]}
        ...
        function(t,addr)
         {if(0 <= addr && ! (16383 < addr))
           {var _v$_=t[3];
            if(t[8] && 32 < _v$_)
             if(64 === _v$_)
              ...
              {if(128 !== _v$_)throw [0,Assert_failure,_rC_];
          ...
          if(40960 <= addr && ! (49151 < addr))
           {if(t[5] && 0 < t[4])
             {var _wa_=ram_addr_of_addr(t,addr);
              return caml_ba_get_1(t[2],_wa_)}
            return 255}
        ...
        function(t,addr,data)
         {if(0 <= addr && ! (8191 < addr)){t[5] = 10 === data?1:0;return 0}
          if(8192 <= addr && ! (16383 < addr))
           {var _v8_=t[3],switch$0=0;
            if(33 <= _v8_)
             if(64 === _v8_ || 128 === _v8_)var _v9_=31;else switch$0 = 1;
            else
             if(17 <= _v8_)
              if(32 <= _v8_)var _v9_=31;else switch$0 = 1;
             else
              if(2 <= _v8_)
               {var switcher=_v8_ - 2 | 0;
                switch(switcher)
                 {case 0:var _v9_=1;break;
                  case 2:var _v9_=3;break;
                  case 6:var _v9_=7;break;
                  case 14:var _v9_=15;break;
                  default:switch$0 = 1}}
              else
               switch$0 = 1;
            if(switch$0)
             throw [0,Invalid_argument,caml_call1(sprintf(_rG_),_v8_)];
            var
             rom_bank_num=data & _v9_,
             _v__=0 === rom_bank_num?1:rom_bank_num;
            t[6] = _v__;
            return 0}
          if(16384 <= addr && ! (24575 < addr)){t[7] = data & 3;return 0}
          if(24576 <= addr && ! (32767 < addr))
           {var _v7_=0 === (data & 1)?0:1;t[8] = _v7_;return 0}
          if(40960 <= addr && ! (49151 < addr))
           {var _v4_=t[5],_v5_=_v4_?0 < t[4]?1:0:_v4_;
            if(_v5_)
             var
              ram_addr=ram_addr_of_addr(t,addr),
              _v6_=caml_ba_set_1(t[2],ram_addr,data);
            else
             var _v6_=_v5_;
            return _v6_}
       ...
       accepts$14=
        function(param,addr)
         {var _v0_=0 <= addr?1:0,_v1_=_v0_?addr <= 32767?1:0:_v0_;
          if(_v1_)
           var _v2_=_v1_;
          else
           var _v3_=40960 <= addr?1:0,_v2_=_v3_?addr <= 49151?1:0:_v3_;
          return _v2_},
       ...
       write_byte$4=function(param,_vZ_,_vY_){return 0},
       accepts$15=
        function(param,addr)
         {var _vW_=0 <= addr?1:0,_vX_=_vW_?addr <= 32767?1:0:_vW_;return _vX_},
                                    ...
                                    default:
                                     return byte_of_bitflags
                                             (486156037 === sprite[4]?1:0,
                                              ...
                                              0 !== (sprite[9] & 1)?1:0)}}
                                return 255}
                              if(accepts$7(_vJ_[4],addr))return read_byte$1(_vJ_[4],addr);
                              if(accepts$7(_vJ_[5],addr))return read_byte$1(_vJ_[5],addr);
                              if(accepts$7(_vJ_[6],addr))return read_byte$1(_vJ_[6],addr);
                              if(accepts$9(_vJ_[7],addr))
                               {var _vG_=_vJ_[7];
                                if(accepts$9(_vG_,addr))
                                 {switch(_vG_[7])
                           ...
                           {if(_ul_(t[1],addr))return _um_(t[1],addr,data);
                            ...
                            if(accepts$13(t[4],addr))
                             {var _vb_=t[4];
                              ...
                              if(accepts$8(_vb_[3],addr))
                               {var match$5=_vb_[7][7];
                                return 2 <= match$5?write_byte$2(_vb_[3],addr,data):0}
                              if(accepts$7(_vb_[4],addr))
                               return write_byte$1(_vb_[4],addr,data);
                              if(accepts$7(_vb_[5],addr))
                               return write_byte$1(_vb_[5],addr,data);
                              if(accepts$7(_vb_[6],addr))
                               return write_byte$1(_vb_[6],addr,data);
                              if(accepts$9(_vb_[7],addr))
                               {var _u7_=_vb_[7];
                                if(accepts$9(_u7_,addr))
                                 {var
                                   match$0=bitflags_of_byte(data),
                                   b3=match$0[5],
                                   b4=match$0[4],
                              ...
                              throw [0,Invalid_argument,caml_call1(sprintf(_cl_),_u__)]}
                            if(accepts$12(t[6],addr))
                             {var
                               _vc_=t[6],
                                 ...
                                 next_byte$0=
                                  function(addr_after_pc,_uE_)
                                   {function next_byte(param)
                                     {return read_byte$2(_uE_,addr_after_pc)}
                                    return next_byte},
