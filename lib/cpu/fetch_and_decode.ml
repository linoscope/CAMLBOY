...
module Make (Mmu : Word_addressable_intf.S) = struct
  ...
  let f mmu ~pc : uint16 * (int * int) * Instruction.t =
    ...
    | 0xCB -> begin
        ...
        | 0x46 -> l2, (3, 3), BIT (0, RR_indirect HL)
        ...
        | 0x4E -> l2, (3, 3), BIT (1, RR_indirect HL)
        ...
        | 0x56 -> l2, (3, 3), BIT (2, RR_indirect HL)
        ...
        | 0x5E -> l2, (3, 3), BIT (3, RR_indirect HL)
        ...
        | 0x66 -> l2, (3, 3), BIT (4, RR_indirect HL)
        ...
        | 0x6E -> l2, (3, 3), BIT (5, RR_indirect HL)
        ...
        | 0x76 -> l2, (3, 3), BIT (6, RR_indirect HL)
        ...
        | 0x7E -> l2, (3, 3), BIT (7, RR_indirect HL)
