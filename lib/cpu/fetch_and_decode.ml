...
module Make (Mmu : Word_addressable_intf.S) = struct
  ...
  let f mmu ~pc : uint16 * (int * int) * Instruction.t =
    ...
    | 0xCB -> begin
        ...
        | 0x3F -> l2, (2, 2), SRL (R A)
        | 0x40 -> l2, (2, 2), BIT (0, R B)
        | 0x41 -> l2, (2, 2), BIT (0, R C)
        | 0x42 -> l2, (2, 2), BIT (0, R D)
        | 0x43 -> l2, (2, 2), BIT (0, R E)
        | 0x44 -> l2, (2, 2), BIT (0, R H)
        | 0x45 -> l2, (2, 2), BIT (0, R L)
        | 0x46 -> l2, (4, 4), BIT (0, RR_indirect HL)
        | 0x47 -> l2, (2, 2), BIT (0, R A)
        | 0x48 -> l2, (2, 2), BIT (1, R B)
        | 0x49 -> l2, (2, 2), BIT (1, R C)
        | 0x4A -> l2, (2, 2), BIT (1, R D)
        | 0x4B -> l2, (2, 2), BIT (1, R E)
        | 0x4C -> l2, (2, 2), BIT (1, R H)
        | 0x4D -> l2, (2, 2), BIT (1, R L)
        | 0x4E -> l2, (4, 4), BIT (1, RR_indirect HL)
        | 0x4F -> l2, (2, 2), BIT (1, R A)
        | 0x50 -> l2, (2, 2), BIT (2, R B)
        | 0x51 -> l2, (2, 2), BIT (2, R C)
        | 0x52 -> l2, (2, 2), BIT (2, R D)
        | 0x53 -> l2, (2, 2), BIT (2, R E)
        | 0x54 -> l2, (2, 2), BIT (2, R H)
        | 0x55 -> l2, (2, 2), BIT (2, R L)
        | 0x56 -> l2, (4, 4), BIT (2, RR_indirect HL)
        | 0x57 -> l2, (2, 2), BIT (2, R A)
        | 0x58 -> l2, (2, 2), BIT (3, R B)
        | 0x59 -> l2, (2, 2), BIT (3, R C)
        | 0x5A -> l2, (2, 2), BIT (3, R D)
        | 0x5B -> l2, (2, 2), BIT (3, R E)
        | 0x5C -> l2, (2, 2), BIT (3, R H)
        | 0x5D -> l2, (2, 2), BIT (3, R L)
        | 0x5E -> l2, (4, 4), BIT (3, RR_indirect HL)
        | 0x5F -> l2, (2, 2), BIT (3, R A)
        | 0x60 -> l2, (2, 2), BIT (4, R B)
        | 0x61 -> l2, (2, 2), BIT (4, R C)
        | 0x62 -> l2, (2, 2), BIT (4, R D)
        | 0x63 -> l2, (2, 2), BIT (4, R E)
        | 0x64 -> l2, (2, 2), BIT (4, R H)
        | 0x65 -> l2, (2, 2), BIT (4, R L)
        | 0x66 -> l2, (4, 4), BIT (4, RR_indirect HL)
        | 0x67 -> l2, (2, 2), BIT (4, R A)
        | 0x68 -> l2, (2, 2), BIT (5, R B)
        | 0x69 -> l2, (2, 2), BIT (5, R C)
        | 0x6A -> l2, (2, 2), BIT (5, R D)
        | 0x6B -> l2, (2, 2), BIT (5, R E)
        | 0x6C -> l2, (2, 2), BIT (5, R H)
        | 0x6D -> l2, (2, 2), BIT (5, R L)
        | 0x6E -> l2, (4, 4), BIT (5, RR_indirect HL)
        | 0x6F -> l2, (2, 2), BIT (5, R A)
        | 0x70 -> l2, (2, 2), BIT (6, R B)
        | 0x71 -> l2, (2, 2), BIT (6, R C)
        | 0x72 -> l2, (2, 2), BIT (6, R D)
        | 0x73 -> l2, (2, 2), BIT (6, R E)
        | 0x74 -> l2, (2, 2), BIT (6, R H)
        | 0x75 -> l2, (2, 2), BIT (6, R L)
        | 0x76 -> l2, (4, 4), BIT (6, RR_indirect HL)
        | 0x77 -> l2, (2, 2), BIT (6, R A)
        | 0x78 -> l2, (2, 2), BIT (7, R B)
        | 0x79 -> l2, (2, 2), BIT (7, R C)
        | 0x7A -> l2, (2, 2), BIT (7, R D)
        | 0x7B -> l2, (2, 2), BIT (7, R E)
        | 0x7C -> l2, (2, 2), BIT (7, R H)
        | 0x7D -> l2, (2, 2), BIT (7, R L)
        | 0x7E -> l2, (4, 4), BIT (7, RR_indirect HL)
        | 0x7F -> l2, (2, 2), BIT (7, R A)
        | 0x80 -> l2, (2, 2), RES (0, R B)
        | 0x81 -> l2, (2, 2), RES (0, R C)
        | 0x82 -> l2, (2, 2), RES (0, R D)
        | 0x83 -> l2, (2, 2), RES (0, R E)
        | 0x84 -> l2, (2, 2), RES (0, R H)
        | 0x85 -> l2, (2, 2), RES (0, R L)
        | 0x86 -> l2, (4, 4), RES (0, RR_indirect HL)
        | 0x87 -> l2, (2, 2), RES (0, R A)
        | 0x88 -> l2, (2, 2), RES (1, R B)
        | 0x89 -> l2, (2, 2), RES (1, R C)
        | 0x8A -> l2, (2, 2), RES (1, R D)
        | 0x8B -> l2, (2, 2), RES (1, R E)
        | 0x8C -> l2, (2, 2), RES (1, R H)
        | 0x8D -> l2, (2, 2), RES (1, R L)
        | 0x8E -> l2, (4, 4), RES (1, RR_indirect HL)
        | 0x8F -> l2, (2, 2), RES (1, R A)
        | 0x90 -> l2, (2, 2), RES (2, R B)
        | 0x91 -> l2, (2, 2), RES (2, R C)
        | 0x92 -> l2, (2, 2), RES (2, R D)
        | 0x93 -> l2, (2, 2), RES (2, R E)
        | 0x94 -> l2, (2, 2), RES (2, R H)
        | 0x95 -> l2, (2, 2), RES (2, R L)
        | 0x96 -> l2, (4, 4), RES (2, RR_indirect HL)
        | 0x97 -> l2, (2, 2), RES (2, R A)
        | 0x98 -> l2, (2, 2), RES (3, R B)
        | 0x99 -> l2, (2, 2), RES (3, R C)
        | 0x9A -> l2, (2, 2), RES (3, R D)
        | 0x9B -> l2, (2, 2), RES (3, R E)
        | 0x9C -> l2, (2, 2), RES (3, R H)
        | 0x9D -> l2, (2, 2), RES (3, R L)
        | 0x9E -> l2, (4, 4), RES (3, RR_indirect HL)
        | 0x9F -> l2, (2, 2), RES (3, R A)
        | 0xA0 -> l2, (2, 2), RES (4, R B)
        | 0xA1 -> l2, (2, 2), RES (4, R C)
        | 0xA2 -> l2, (2, 2), RES (4, R D)
        | 0xA3 -> l2, (2, 2), RES (4, R E)
        | 0xA4 -> l2, (2, 2), RES (4, R H)
        | 0xA5 -> l2, (2, 2), RES (4, R L)
        | 0xA6 -> l2, (4, 4), RES (4, RR_indirect HL)
        | 0xA7 -> l2, (2, 2), RES (4, R A)
        | 0xA8 -> l2, (2, 2), RES (5, R B)
        | 0xA9 -> l2, (2, 2), RES (5, R C)
        | 0xAA -> l2, (2, 2), RES (5, R D)
        | 0xAB -> l2, (2, 2), RES (5, R E)
        | 0xAC -> l2, (2, 2), RES (5, R H)
        | 0xAD -> l2, (2, 2), RES (5, R L)
        | 0xAE -> l2, (4, 4), RES (5, RR_indirect HL)
        | 0xAF -> l2, (2, 2), RES (5, R A)
        | 0xB0 -> l2, (2, 2), RES (6, R B)
        | 0xB1 -> l2, (2, 2), RES (6, R C)
        | 0xB2 -> l2, (2, 2), RES (6, R D)
        | 0xB3 -> l2, (2, 2), RES (6, R E)
        | 0xB4 -> l2, (2, 2), RES (6, R H)
        | 0xB5 -> l2, (2, 2), RES (6, R L)
        | 0xB6 -> l2, (4, 4), RES (6, RR_indirect HL)
        | 0xB7 -> l2, (2, 2), RES (6, R A)
        | 0xB8 -> l2, (2, 2), RES (7, R B)
        | 0xB9 -> l2, (2, 2), RES (7, R C)
        | 0xBA -> l2, (2, 2), RES (7, R D)
        | 0xBB -> l2, (2, 2), RES (7, R E)
        | 0xBC -> l2, (2, 2), RES (7, R H)
        | 0xBD -> l2, (2, 2), RES (7, R L)
        | 0xBE -> l2, (4, 4), RES (7, RR_indirect HL)
        | 0xBF -> l2, (2, 2), RES (7, R A)
        | 0xC0 -> l2, (2, 2), SET (0, R B)
        | 0xC1 -> l2, (2, 2), SET (0, R C)
        | 0xC2 -> l2, (2, 2), SET (0, R D)
        | 0xC3 -> l2, (2, 2), SET (0, R E)
        | 0xC4 -> l2, (2, 2), SET (0, R H)
        | 0xC5 -> l2, (2, 2), SET (0, R L)
        | 0xC6 -> l2, (4, 4), SET (0, RR_indirect HL)
        | 0xC7 -> l2, (2, 2), SET (0, R A)
        | 0xC8 -> l2, (2, 2), SET (1, R B)
        | 0xC9 -> l2, (2, 2), SET (1, R C)
        | 0xCA -> l2, (2, 2), SET (1, R D)
        | 0xCB -> l2, (2, 2), SET (1, R E)
        | 0xCC -> l2, (2, 2), SET (1, R H)
        | 0xCD -> l2, (2, 2), SET (1, R L)
        | 0xCE -> l2, (4, 4), SET (1, RR_indirect HL)
        | 0xCF -> l2, (2, 2), SET (1, R A)
        | 0xD0 -> l2, (2, 2), SET (2, R B)
        | 0xD1 -> l2, (2, 2), SET (2, R C)
        | 0xD2 -> l2, (2, 2), SET (2, R D)
        | 0xD3 -> l2, (2, 2), SET (2, R E)
        | 0xD4 -> l2, (2, 2), SET (2, R H)
        | 0xD5 -> l2, (2, 2), SET (2, R L)
        | 0xD6 -> l2, (4, 4), SET (2, RR_indirect HL)
        | 0xD7 -> l2, (2, 2), SET (2, R A)
        | 0xD8 -> l2, (2, 2), SET (3, R B)
        | 0xD9 -> l2, (2, 2), SET (3, R C)
        | 0xDA -> l2, (2, 2), SET (3, R D)
        | 0xDB -> l2, (2, 2), SET (3, R E)
        | 0xDC -> l2, (2, 2), SET (3, R H)
        | 0xDD -> l2, (2, 2), SET (3, R L)
        | 0xDE -> l2, (4, 4), SET (3, RR_indirect HL)
        | 0xDF -> l2, (2, 2), SET (3, R A)
        | 0xE0 -> l2, (2, 2), SET (4, R B)
        | 0xE1 -> l2, (2, 2), SET (4, R C)
        | 0xE2 -> l2, (2, 2), SET (4, R D)
        | 0xE3 -> l2, (2, 2), SET (4, R E)
        | 0xE4 -> l2, (2, 2), SET (4, R H)
        | 0xE5 -> l2, (2, 2), SET (4, R L)
        | 0xE6 -> l2, (4, 4), SET (4, RR_indirect HL)
        | 0xE7 -> l2, (2, 2), SET (4, R A)
        | 0xE8 -> l2, (2, 2), SET (5, R B)
        | 0xE9 -> l2, (2, 2), SET (5, R C)
        | 0xEA -> l2, (2, 2), SET (5, R D)
        | 0xEB -> l2, (2, 2), SET (5, R E)
        | 0xEC -> l2, (2, 2), SET (5, R H)
        | 0xED -> l2, (2, 2), SET (5, R L)
        | 0xEE -> l2, (4, 4), SET (5, RR_indirect HL)
        | 0xEF -> l2, (2, 2), SET (5, R A)
        | 0xF0 -> l2, (2, 2), SET (6, R B)
        | 0xF1 -> l2, (2, 2), SET (6, R C)
        | 0xF2 -> l2, (2, 2), SET (6, R D)
        | 0xF3 -> l2, (2, 2), SET (6, R E)
        | 0xF4 -> l2, (2, 2), SET (6, R H)
        | 0xF5 -> l2, (2, 2), SET (6, R L)
        | 0xF6 -> l2, (4, 4), SET (6, RR_indirect HL)
        | 0xF7 -> l2, (2, 2), SET (6, R A)
        | 0xF8 -> l2, (2, 2), SET (7, R B)
        | 0xF9 -> l2, (2, 2), SET (7, R C)
        | 0xFA -> l2, (2, 2), SET (7, R D)
        | 0xFB -> l2, (2, 2), SET (7, R E)
        | 0xFC -> l2, (2, 2), SET (7, R H)
        | 0xFD -> l2, (2, 2), SET (7, R L)
        | 0xFE -> l2, (4, 4), SET (7, RR_indirect HL)
        | 0xFF -> l2, (2, 2), SET (7, R A)
