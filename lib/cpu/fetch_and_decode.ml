...
module Make (Mmu : Word_addressable_intf.S) = struct
  ...
  let f mmu ~pc =
    ...
    | 0x46 -> l1, (2, 2), LD (R B, RR_indirect HL)
    ...
    | 0x4E -> l1, (2, 2), LD (R C, RR_indirect HL)
    ...
    | 0x56 -> l1, (2, 2), LD (R D, RR_indirect HL)
    ...
    | 0x7E -> l1, (2, 2), LD (R A, RR_indirect HL)
    ...
    | 0x86 -> l1, (2, 2), ADD (R A, RR_indirect HL)
    ...
    | 0xC0 -> l1, (2, 5), RET NZ
    | 0xC1 -> l1, (3, 3), POP BC
    | 0xC2 -> l3, (3, 4), JP (NZ, Immediate (next_word ()))
    | 0xC3 -> l3, (4, 4), JP (None, Immediate (next_word ()))
    ...
    | 0xCA -> l3, (3, 4), JP (Z, Immediate  (next_word ()))
    ...
    | 0xD0 -> l1, (2, 5), RET NC
    | 0xD1 -> l1, (3, 3), POP DE
    | 0xD2 -> l3, (3, 4), JP (NC, Immediate (next_word ()))
    | 0xD3 -> l1, (1, 1), NOP
