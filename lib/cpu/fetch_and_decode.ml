...
module Make (Mmu : Word_addressable.S) = struct
  ...
  let f mmu ~pc : uint16 * (int * int) * Instruction.t =
    ...
    | 0xCB -> begin
        ...
        | 0x47 -> l2, (2, 2), BIT (Bit_pos.b0, R A)
        ...
        | 0x57 -> l2, (2, 2), BIT (Bit_pos.b2, R A)
        ...
        | 0x67 -> l2, (2, 2), BIT (Bit_pos.b4, R A)
        ...
        | 0x77 -> l2, (2, 2), BIT (Bit_pos.b6, R A)
        ...
        | 0x87 -> l2, (2, 2), RES (Bit_pos.b0, R A)
        ...
        | 0x97 -> l2, (2, 2), RES (Bit_pos.b2, R A)
        ...
        | 0xA7 -> l2, (2, 2), RES (Bit_pos.b4, R A)
        ...
        | 0xB7 -> l2, (2, 2), RES (Bit_pos.b6, R A)
        ...
        | 0xC7 -> l2, (2, 2), SET (Bit_pos.b0, R A)
        ...
        | 0xD7 -> l2, (2, 2), SET (Bit_pos.b2, R A)
        ...
        | 0xE7 -> l2, (2, 2), SET (Bit_pos.b4, R A)
        ...
        | 0xF7 -> l2, (2, 2), SET (Bit_pos.b6, R A)
