...
module Make (Mmu : Word_addressable_intf.S) = struct
  ...
  let f mmu ~pc =
    ...
    | 0x07 -> l1, (1, 1), RLCA
    | 0x08 -> l3, (3, 3), LD16 (Direct (next_word ()), SP)
    | 0x09 -> l1, (1, 1), ADD16 (RR HL, RR BC)
    | 0x0A -> l1, (2, 2), LD (R A, RR_indirect BC)
    | 0x0B -> l1, (2, 2), DEC16 (RR BC)
    | 0x0C -> l1, (1, 1), INC (R C)
    | 0x0D -> l1, (1, 1), DEC (R C)
    | 0x0E -> l2, (2, 2), LD (R C, Immediate (next_byte ()))
    | 0x0F -> l1, (1, 1), RRCA
    | 0x10 -> ignore(next_byte ()); l2, (2, 2), STOP
    | 0x11 -> l3, (3, 3), LD16 (RR DE, Immediate (next_word ()))
    | 0x12 -> l1, (2, 2), LD (RR_indirect DE, R A)
    | 0x13 -> l1, (2, 2), INC16 (RR DE)
    | 0x14 -> l1, (1, 1), INC (R D)
    | 0x15 -> l1, (1, 1), DEC (R D)
    | 0x16 -> l2, (2, 2), LD (R D, Immediate (next_byte ()))
    | 0x17 -> l1, (1, 1), RLA
    | 0x18 -> l2, (2, 2), JR (None, (next_byte ()))
    | 0x19 -> l1, (1, 1), ADD16 (RR HL, RR DE)
    | 0x1A -> l1, (2, 2), LD (R A, RR_indirect DE)
    | 0x1B -> l1, (2, 2), DEC16 (RR DE)
    | 0x1C -> l1, (1, 1), INC (R E)
    | 0x1D -> l1, (1, 1), DEC (R E)
    | 0x1E -> l2, (2, 2), LD (R E, Immediate (next_byte ()))
    | 0x1F -> l1, (1, 1), RRA
    | 0x20 -> l2, (2, 2), JR (NZ, next_byte ())
    | 0x21 -> l3, (3, 3), LD16 (RR HL, Immediate (next_word ()))
    | 0x22 -> l1, (1, 1), LD (HL_inc, R A)
    | 0x23 -> l1, (2, 2), INC16 (RR HL)
    | 0x24 -> l1, (1, 1), INC (R H)
    | 0x25 -> l1, (1, 1), DEC (R H)
    | 0x26 -> l2, (2, 2), LD (R H, Immediate (next_byte ()))
    | 0x27 -> l1, (1, 1), DAA
    | 0x28 -> l2, (2, 2), JR (Z, next_byte ())
    | 0x29 -> l1, (1, 1), ADD16 (RR HL,RR HL)
    | 0x2A -> l1, (2, 2), LD (R A, HL_inc)
    | 0x2B -> l1, (2, 2), DEC16 (RR HL)
    | 0x2C -> l1, (1, 1), INC (R L)
    | 0x2D -> l1, (1, 1), DEC (R L)
    | 0x2E -> l2, (2, 2), LD (R L, Immediate (next_byte ()))
    | 0x2F -> l1, (1, 1), CPL
    | 0x30 -> l2, (2, 2), JR (NC, next_byte ())
    | 0x31 -> l3, (3, 3), LD16 (SP, Immediate (next_word ()))
    | 0x32 -> l1, (1, 1), LD (HL_dec, R A)
    | 0x33 -> l1, (2, 2), INC16 SP
    | 0x34 -> l1, (1, 1), INC (RR_indirect HL)
    | 0x35 -> l1, (1, 1), DEC (RR_indirect HL)
    | 0x36 -> l2, (2, 2), LD (RR_indirect HL, Immediate (next_byte ()))
    | 0x37 -> l1, (1, 1), SCF
    | 0x38 -> l2, (2, 2), JR (C, next_byte ())
    | 0x39 -> l1, (1, 1), ADD16 (RR HL, SP)
    | 0x3A -> l1, (2, 2), LD (R A, HL_dec)
    | 0x3B -> l1, (2, 2), DEC16 SP
    | 0x3C -> l1, (1, 1), INC (R A)
    | 0x3D -> l1, (1, 1), DEC (R A)
    | 0x3E -> l2, (2, 2), LD (R A, Immediate (next_byte ()))
    | 0x3F -> l1, (1, 1), CCF
    | 0x40 -> l1, (1, 1), LD (R B, R B)
    | 0x41 -> l1, (1, 1), LD (R B, R C)
    | 0x42 -> l1, (1, 1), LD (R B, R D)
    | 0x43 -> l1, (1, 1), LD (R B, R E)
    | 0x44 -> l1, (1, 1), LD (R B, R H)
    | 0x45 -> l1, (1, 1), LD (R B, R F)
    | 0x46 -> l1, (1, 1), LD (R B, RR_indirect HL)
    | 0x47 -> l1, (1, 1), LD (R B, R A)
    | 0x48 -> l1, (1, 1), LD (R C, R B)
    | 0x49 -> l1, (1, 1), LD (R C, R C)
    | 0x4A -> l1, (1, 1), LD (R C, R D)
    | 0x4B -> l1, (1, 1), LD (R C, R E)
    | 0x4C -> l1, (1, 1), LD (R C, R H)
    | 0x4D -> l1, (1, 1), LD (R C, R L)
    | 0x4E -> l1, (1, 1), LD (R C, RR_indirect HL)
    | 0x4F -> l1, (1, 1), LD (R C, R A)
    | 0x50 -> l1, (1, 1), LD (R D, R B)
    | 0x51 -> l1, (1, 1), LD (R D, R C)
    | 0x52 -> l1, (1, 1), LD (R D, R D)
    | 0x53 -> l1, (1, 1), LD (R D, R E)
    | 0x54 -> l1, (1, 1), LD (R D, R H)
    | 0x55 -> l1, (1, 1), LD (R D, R L)
    | 0x56 -> l1, (1, 1), LD (R D, RR_indirect HL)
    | 0x57 -> l1, (1, 1), LD (R D, R A)
    | 0x58 -> l1, (1, 1), LD (R E, R B)
    | 0x59 -> l1, (1, 1), LD (R E, R C)
    | 0x5A -> l1, (1, 1), LD (R E, R D)
    | 0x5B -> l1, (1, 1), LD (R E, R E)
    | 0x5C -> l1, (1, 1), LD (R E, R H)
    | 0x5D -> l1, (1, 1), LD (R E, R L)
    | 0x5E -> l1, (1, 1), LD (R E, RR_indirect HL)
    | 0x5F -> l1, (1, 1), LD (R E, R A)
    | 0x60 -> l1, (1, 1), LD (R H, R B)
    | 0x61 -> l1, (1, 1), LD (R H, R C)
    | 0x62 -> l1, (1, 1), LD (R H, R D)
    | 0x63 -> l1, (1, 1), LD (R H, R E)
    | 0x64 -> l1, (1, 1), LD (R H, R H)
    | 0x65 -> l1, (1, 1), LD (R H, R L)
    | 0x66 -> l1, (1, 1), LD (R H, RR_indirect HL)
    | 0x67 -> l1, (1, 1), LD (R H, R A)
    | 0x68 -> l1, (1, 1), LD (R L, R B)
    | 0x69 -> l1, (1, 1), LD (R L, R C)
    | 0x6A -> l1, (1, 1), LD (R L, R D)
    | 0x6B -> l1, (1, 1), LD (R L, R E)
    | 0x6C -> l1, (1, 1), LD (R L, R H)
    | 0x6D -> l1, (1, 1), LD (R L, R L)
    | 0x6E -> l1, (1, 1), LD (R L, R E)
    | 0x6F -> l1, (1, 1), LD (R L, R A)
    | 0x70 -> l1, (2, 2), LD (RR_indirect HL, R B)
    | 0x71 -> l1, (2, 2), LD (RR_indirect HL, R C)
    | 0x72 -> l1, (2, 2), LD (RR_indirect HL, R D)
    | 0x73 -> l1, (2, 2), LD (RR_indirect HL, R E)
    | 0x74 -> l1, (2, 2), LD (RR_indirect HL, R H)
    | 0x75 -> l1, (2, 2), LD (RR_indirect HL, R L)
    | 0x76 -> l1, (1, 1), HALT
    | 0x77 -> l1, (2, 2), LD (RR_indirect HL, R A)
    | 0x78 -> l1, (1, 1), LD (R A, R B)
    | 0x79 -> l1, (1, 1), LD (R A, R C)
    | 0x7A -> l1, (1, 1), LD (R A, R D)
    | 0x7B -> l1, (1, 1), LD (R A, R E)
    | 0x7C -> l1, (1, 1), LD (R A, R H)
    | 0x7D -> l1, (1, 1), LD (R A, R L)
    | 0x7E -> l1, (1, 1), LD (R A, RR_indirect HL)
    | 0x7F -> l1, (1, 1), LD (R A, R A)
    | 0x80 -> l1, (1, 1), ADD (R A, R B)
    | 0x81 -> l1, (1, 1), ADD (R A, R C)
    | 0x82 -> l1, (1, 1), ADD (R A, R D)
    | 0x83 -> l1, (1, 1), ADD (R A, R E)
    | 0x84 -> l1, (1, 1), ADD (R A, R H)
    | 0x85 -> l1, (1, 1), ADD (R A, R L)
    | 0x86 -> l1, (1, 1), ADD (R A, RR_indirect HL)
    | 0x87 -> l1, (1, 1), ADD (R A, (R A))
    ...
    | 0x8E -> l1, (1, 1), ADC (R A, RR_indirect HL)
    ...
    | 0x96 -> l1, (1, 1), SUB (R A, RR_indirect HL)
    ...
    | 0x9E -> l1, (1, 1), SBC (R A, RR_indirect HL)
    ...
    | 0xA6 -> l1, (1, 1), AND (R A, RR_indirect HL)
    ...
    | 0xAE -> l1, (1, 1), XOR (R A, RR_indirect HL)
    ...
    | 0xB6 -> l1, (1, 1), OR (R A, RR_indirect HL)
    ...
    | 0xBE -> l1, (1, 1), CP (R A, RR_indirect HL)
    | 0xBF -> l1, (1, 1), CP (R A, R A)
    | 0xC0 -> l1, (1, 1), RET NZ
    | 0xC1 -> l1, (1, 1), POP BC
    | 0xC2 -> l3, (3, 3), JP (NZ, Immediate (next_word ()))
    | 0xC3 -> l3, (3, 3), JP (None, Immediate (next_word ()))
    | 0xC4 -> l3, (3, 3), CALL (NZ, next_word ())
    | 0xC5 -> l1, (1, 1), PUSH BC
    | 0xC6 -> l2, (2, 2), ADD (R A, (Immediate (next_byte ())))
    | 0xC7 -> l1, (1, 1), RST RST_offset.x00
    | 0xC8 -> l1, (1, 1), RET Z
    | 0xC9 -> l1, (1, 1), RET None
    | 0xCA -> l3, (3, 3), JP (Z, Immediate  (next_word ()))
    | 0xCC -> l3, (3, 3), CALL (Z, next_word ())
    | 0xCD -> l3, (3, 3), CALL (None, next_word ())
    | 0xCE -> l2, (2, 2), ADC (R A, Immediate (next_byte ()))
    | 0xCF -> l1, (1, 1), RST RST_offset.x08
    | 0xD0 -> l1, (1, 1), RET NC
    | 0xD1 -> l1, (1, 1), POP DE
    | 0xD2 -> l3, (3, 3), JP (NC, Immediate (next_word ()))
    | 0xD3 -> l1, (1, 1), NOP
    | 0xD4 -> l3, (3, 3), CALL (NC, next_word ())
    | 0xD5 -> l1, (1, 1), PUSH DE
    | 0xD6 -> l2, (2, 2), SUB (R A, Immediate (next_byte ()))
    | 0xD7 -> l1, (1, 1), RST RST_offset.x10
    | 0xD8 -> l1, (1, 1), RET C
    | 0xD9 -> l1, (1, 1), RETI
    | 0xDA -> l3, (3, 3), JP (C, Immediate (next_word ()))
    | 0xDB -> l1, (1, 1), NOP
    | 0xDC -> l3, (3, 3), CALL (C, next_word ())
    | 0xDD -> l1, (1, 1), NOP
    | 0xDE -> l2, (2, 2), SBC (R A, Immediate (next_byte ()))
    | 0xDF -> l1, (1, 1), RST RST_offset.x18
    | 0xE0 -> l2, (2, 2), LD (FF00_offset (next_byte ()), R A)
    | 0xE1 -> l1, (1, 1), POP HL
    | 0xE2 -> l1, (1, 1), LD (FF00_C, R A)
    | 0xE3 -> l1, (1, 1), NOP
    | 0xE4 -> l1, (1, 1), NOP
    | 0xE5 -> l1, (1, 1), PUSH HL
    | 0xE6 -> l2, (2, 2), AND (R A, Immediate (next_byte ()))
    | 0xE7 -> l1, (1, 1), RST RST_offset.x20
    | 0xE8 -> l2, (2, 2), ADD16 (SP, Immediate8 (next_byte ()))
    | 0xE9 -> l1, (1, 1), JP (None, RR HL)
    | 0xEA -> l3, (3, 3), LD (Direct (next_word ()), R A)
    | 0xEB -> l1, (1, 1), NOP
    | 0xEC -> l1, (1, 1), NOP
    | 0xED -> l1, (1, 1), NOP
    | 0xEE -> l2, (2, 2), XOR (R A, Immediate (next_byte ()))
    | 0xEF -> l1, (1, 1), RST RST_offset.x28
    | 0xF0 -> l2, (3, 3), LD (R A, FF00_offset (next_byte ()))
    | 0xF1 -> l1, (1, 1), POP AF
    | 0xF2 -> l1, (2, 2), LD (R A, FF00_C)
    | 0xF3 -> l1, (1, 1), DI
    | 0xF4 -> l1, (1, 1), NOP
    | 0xF5 -> l1, (1, 1), PUSH AF
    | 0xF6 -> l2, (2, 2), OR (R A, Immediate (next_byte ()))
    | 0xF7 -> l1, (1, 1), RST RST_offset.x30
    | 0xF8 -> l2, (2, 2), LD16 (RR HL, SP_offset (next_byte ()))
    | 0xF9 -> l1, (1, 1), LD16 (SP, RR HL)
    | 0xFA -> l3, (4, 4), LD (R A, Direct (next_word ()))
    | 0xFB -> l1, (1, 1), EI
    | 0xFC -> l1, (1, 1), NOP
    | 0xFD -> l1, (1, 1), NOP
    | 0xFE -> l2, (2, 2), CP (R A, Immediate (next_byte ()))
    | 0xFF -> l1, (1, 1), RST RST_offset.x38
    | 0xCB -> begin
        ...
        | 0x04 -> l2, (2, 2), RLC (R H)
        | 0x05 -> l2, (2, 2), RLC (R L)
        | 0x06 -> l2, (2, 2), RLC (RR_indirect HL)
        | 0x07 -> l2, (2, 2), RRC (R A)
        | 0x08 -> l2, (2, 2), RRC (R B)
        | 0x09 -> l2, (2, 2), RRC (R C)
        | 0x0A -> l2, (2, 2), RRC (R D)
        ...
        | 0x0C -> l2, (2, 2), RRC (R H)
        | 0x0D -> l2, (2, 2), RRC (R L)
        | 0x0E -> l2, (2, 2), RRC (RR_indirect HL)
        | 0x0F -> l2, (2, 2), RRC (R A)
        | 0x10 -> l2, (2, 2), RL (R B)
        | 0x11 -> l2, (2, 2), RL (R C)
        | 0x12 -> l2, (2, 2), RL (R D)
        ...
        | 0x24 -> l2, (2, 2), SLA (R H)
        | 0x25 -> l2, (2, 2), SLA (R L)
        | 0x26 -> l2, (2, 2), SLA (RR_indirect HL)
        | 0x27 -> l2, (2, 2), SRA (R A)
        | 0x28 -> l2, (2, 2), SRA (R B)
        | 0x29 -> l2, (2, 2), SRA (R C)
        | 0x2A -> l2, (2, 2), SRA (R D)
        ...
        | 0x2C -> l2, (2, 2), SRA (R H)
        | 0x2D -> l2, (2, 2), SRA (R L)
        | 0x2E -> l2, (2, 2), SRA (RR_indirect HL)
        | 0x2F -> l2, (2, 2), SRA (R A)
        ...
        | 0x36 -> l2, (2, 2), SWAP (RR_indirect HL)
        | 0x37 -> l2, (2, 2), SRL (R A)
        | 0x38 -> l2, (2, 2), SRL (R B)
        | 0x39 -> l2, (2, 2), SRL (R C)
        | 0x3A -> l2, (2, 2), SRL (R D)
        ...
        | 0x3C -> l2, (2, 2), SRL (R H)
        | 0x3D -> l2, (2, 2), SRL (R L)
        | 0x3E -> l2, (2, 2), SRL (RR_indirect HL)
        | 0x3F -> l2, (2, 2), SRL (R A)
        ...
        | 0x46 -> l2, (2, 2), BIT (Bit_pos.b0, RR_indirect HL)
        ...
        | 0x4E -> l2, (2, 2), BIT (Bit_pos.b1, RR_indirect HL)
        ...
        | 0x56 -> l2, (2, 2), BIT (Bit_pos.b2, RR_indirect HL)
        ...
        | 0x5E -> l2, (2, 2), BIT (Bit_pos.b3, RR_indirect HL)
        ...
        | 0x66 -> l2, (2, 2), BIT (Bit_pos.b4, RR_indirect HL)
        ...
        | 0x6E -> l2, (2, 2), BIT (Bit_pos.b5, RR_indirect HL)
        ...
        | 0x76 -> l2, (2, 2), BIT (Bit_pos.b6, RR_indirect HL)
        ...
        | 0x7E -> l2, (2, 2), BIT (Bit_pos.b7, RR_indirect HL)
        ...
        | 0x86 -> l2, (2, 2), RES (Bit_pos.b0, RR_indirect HL)
        ...
        | 0x8E -> l2, (2, 2), RES (Uint8.one, RR_indirect HL)
        ...
        | 0x96 -> l2, (2, 2), RES (Bit_pos.b2, RR_indirect HL)
        ...
        | 0x9E -> l2, (2, 2), RES (Bit_pos.b3, RR_indirect HL)
        ...
        | 0xA6 -> l2, (2, 2), RES (Bit_pos.b4, RR_indirect HL)
        ...
        | 0xAE -> l2, (2, 2), RES (Bit_pos.b5, RR_indirect HL)
        ...
        | 0xB6 -> l2, (2, 2), RES (Bit_pos.b6, RR_indirect HL)
        ...
        | 0xBE -> l2, (2, 2), RES (Bit_pos.b7, RR_indirect HL)
        ...
        | 0xC6 -> l2, (2, 2), SET (Bit_pos.b0, RR_indirect HL)
        ...
        | 0xCE -> l2, (2, 2), SET (Bit_pos.b1, RR_indirect HL)
        ...
        | 0xD6 -> l2, (2, 2), SET (Bit_pos.b2, RR_indirect HL)
        ...
        | 0xDE -> l2, (2, 2), SET (Bit_pos.b3, RR_indirect HL)
        ...
        | 0xE6 -> l2, (2, 2), SET (Bit_pos.b4, RR_indirect HL)
        ...
        | 0xEE -> l2, (2, 2), SET (Bit_pos.b5, RR_indirect HL)
        ...
        | 0xF6 -> l2, (2, 2), SET (Bit_pos.b6, RR_indirect HL)
        ...
        | 0xFE -> l2, (2, 2), SET (Bit_pos.b7, RR_indirect HL)
