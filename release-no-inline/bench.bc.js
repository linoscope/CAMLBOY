   ...
   {"use strict";
    ...
    function show$1(t)
     {var
      ...
      return caml_call5(sprintf(_co_),_x__,_x9_,_x8_,_x7_,_x6_)}
    ...
    function read_byte$9(t,addr)
     {if(accepts$9(t,addr))
       {switch(t[7])
         {case 0:var _xE_=0,_xF_=1,b0=_xE_,b1=_xF_;break;
          case 1:var _xK_=1,_xL_=1,b0=_xK_,b1=_xL_;break;
          case 2:var _xM_=0,_xN_=0,b0=_xM_,b1=_xN_;break;
        ...
        var
         ...
         _xI_=is_enabled(t,2),
         _xJ_=is_enabled(t,1);
        return byte_of_bitflags(1,is_enabled(t,0),_xJ_,_xI_,_xH_,_xG_,b1,b0)}
    ...
    function accepts$10(t,addr)
     {var
      ...
      function _xC_(x){return caml_call2(symbol$5,addr,x)}
      return function(_xD_){return exists(_xC_,_xD_)}(_xB_)}
    function register_of_addr(t,addr)
     {if(caml_call2(symbol$5,addr,t[1][1]))return t[1];
      ...
      var _xA_=caml_call1(show$0,addr);
      throw [0,Invalid_argument,caml_call1(sprintf(_cw_),_xA_)]}
    ...
    function write_byte$11(t,addr,data)
     {if(accepts$11(t,addr))
       {var
        ...
        var _xy_=b3?1:0;
        t[6] = _xy_;
        var _xz_=b2?-663730172:1056320505;
        t[7] = _xz_;
        t[8] = b1;
        t[9] = b0;
        return 0}
    ...
    function read_byte$12(t,param)
     {switch(t[3])
       {case 0:return of_int(15);
        case 1:
         var _xq_=to_bool(t[7]),_xr_=to_bool(t[6]),_xs_=to_bool(t[5]);
         return byte_of_bitflags(1,1,0,1,to_bool(t[4]),_xs_,_xr_,_xq_);
        default:
         var _xt_=to_bool(t[11]),_xu_=to_bool(t[10]),_xv_=to_bool(t[9]);
         return byte_of_bitflags(1,1,1,0,to_bool(t[8]),_xv_,_xu_,_xt_)}}
    ...
    function handle_ly_eq_lyc(t)
     {var ly=get_ly(t[9]),lyc=get_lyc(t[9]),ly_eq_lyc=ly === lyc?1:0;
      ...
      var _xp_=ly_eq_lyc?is_enabled(t[7],0):ly_eq_lyc;
      return _xp_?request(t[10],1):_xp_}
    ...
    function render_bg_window_line(t,ly)
     {function render_bg_line(t,ly,tile_data_area)
           ...
           {var
            ...
            if(! (_xk_ < 0))
             {var i=_xj_;
              for(;;)
               {var
                 _xl_=col_in_tile + i | 0,
                 _xm_=caml_check_bound(tile_pixel_row,_xl_)[1 + _xl_],
                 color=lookup(t[4],_xm_),
                 _xn_=lx[1] + i | 0;
                caml_check_bound(caml_check_bound(t[13],ly)[1 + ly],_xn_)
                 [1 + _xn_]
                =
                color;
                var _xo_=i + 1 | 0;
                if(_xk_ !== i){var i=_xo_;continue}
                break}}
            lx[1] = lx[1] + len | 0;
            continue}
          return 0}}
      function render_window_line(t,ly,tile_data_area)
       {var wy=get_wy(t[9]),wx=get_wx(t[9]) - 7 | 0,_xa_=wy <= ly?1:0;
        if(_xa_)
         var _xb_=ly <= (wy + 256 | 0)?1:0,_xc_=_xb_?wx <= 160?1:0:_xb_;
        else
         var _xc_=_xa_;
        if(_xc_)
         {var
             ...
             {var
              ...
              if(! (_xe_ < 0))
               {var i=_xd_;
                for(;;)
                 {var
                   _xf_=caml_check_bound(tile_pixel_row,i)[1 + i],
                   color=lookup(t[4],_xf_),
                   _xg_=lx[1] + i | 0;
                  caml_check_bound(caml_check_bound(t[13],ly)[1 + ly],_xg_)
                   [1 + _xg_]
                  =
                  color;
                  var _xh_=i + 1 | 0;
                  if(_xe_ !== i){var i=_xh_;continue}
                  break}}
              lx[1] = lx[1] + len | 0;
              continue}
            var _xi_=0;
      ...
      var _w$_=get_window_enable(t[8]);
      return _w$_?render_window_line(t,ly,tile_data_area):_w$_}
    function render_sprite_line(t,ly)
     {var
       match=get_obj_size(t[8]),
       y_sprite_size=1056320505 <= match?8:16,
       _w2_=get_all_sprites(t[3]);
      function _w3_(sprite)
       {var
         _w5_=sprite[1] <= ly?1:0,
         _w6_=_w5_?ly <= ((sprite[1] + y_sprite_size | 0) - 1 | 0)?1:0:_w5_;
        if(_w6_)
         {var
           row=ly - sprite[1] | 0,
          ...
          for(;;)
           {var lx=sprite[2] + col | 0,switch$0=0;
            if(0 <= lx && ! (160 <= lx))
             {var
               _w9_=sprite[6]?7 - col | 0:col,
               _w__=sprite[5]?(y_sprite_size - row | 0) - 1 | 0:row,
               color_id=get_pixel(t[1],0,sprite[3],_w__,_w9_);
              if(color_id)
               {var
                 match=sprite[4],
                 match$0=
              ...
              switch$0 = 1}
            var _w8_=col + 1 | 0;
            if(7 !== col){var col=_w8_;continue}
            var _w7_=0;
            break}}
        else
         var _w7_=_w6_;
        return _w7_}
      return function(_w4_){return iter$0(_w3_,_w4_)}(_w2_)}
    function render_line(t)
     {var ly=get_ly(t[9]);
      if(get_bg_window_display(t[8]))render_bg_window_line(t,ly);
      var _w1_=get_obj_enable(t[8]);
      return _w1_?render_sprite_line(t,ly):_w1_}
    ...
    function accepts$13(t,addr)
     {var _wS_=accepts$1(t[2],addr);
      if(_wS_)
       var _wT_=_wS_;
      else
       {var _wU_=accepts$2(t[1],addr);
        if(_wU_)
         var _wT_=_wU_;
        else
         {var _wV_=accepts$8(t[3],addr);
          if(_wV_)
           var _wT_=_wV_;
          else
           {var _wW_=accepts$7(t[4],addr);
            if(_wW_)
             var _wT_=_wW_;
            else
             {var _wX_=accepts$7(t[5],addr);
              if(_wX_)
               var _wT_=_wX_;
              else
               {var _wY_=accepts$7(t[6],addr);
                if(_wY_)
                 var _wT_=_wY_;
                else
                 {var _wZ_=accepts$9(t[7],addr);
                  if(_wZ_)
                   var _wT_=_wZ_;
                  else
                   {var _w0_=accepts$11(t[8],addr);
                    if(! _w0_)return accepts$10(t[9],addr);
                    var _wT_=_w0_}}}}}}}
      return _wT_}
    function read_byte$13(t,addr)
     {if(accepts$2(t[1],addr))
      ...
      var _wR_=caml_call1(show$0,addr);
      throw [0,Invalid_argument,caml_call1(sprintf(_cz_),_wR_)]}
    function write_byte$13(t,addr,data)
     {if(accepts$2(t[1],addr))
      ...
      var _wQ_=caml_call1(show$0,addr);
      throw [0,Invalid_argument,caml_call1(sprintf(_cA_),_wQ_)]}
      ...
      function f(bus,pc)
       {var addr_after_pc=succ$0(pc);
        ...
        if(128 <= _wO_)
         {if(192 <= _wO_)
           {if(224 <= _wO_)
             switch(_wO_)
              {case 224:
                var _wE_=[0,[7,next_byte(0)],_q3_];
                return [0,Instruction_length[2],_q4_,_wE_];
               ...
               case 230:
                var _wF_=[8,_rb_,[0,next_byte(0)]];
                return [0,Instruction_length[2],_rc_,_wF_];
               case 231:
                return [0,Instruction_length[1],_rd_,[32,RST_offset[5]]];
               case 232:
                var _wG_=[4,of_byte(next_byte(0))];
                return [0,Instruction_length[2],_re_,_wG_];
               case 233:return [0,Instruction_length[1],_rg_,_rf_];
               case 234:
                var _wH_=[0,[2,next_word(0)],_rh_];
                return [0,Instruction_length[3],_ri_,_wH_];
               ...
               case 238:
                var _wI_=[10,_rm_,[0,next_byte(0)]];
                return [0,Instruction_length[2],_rn_,_wI_];
               case 239:
                return [0,Instruction_length[1],_ro_,[32,RST_offset[6]]];
               case 240:
                var _wJ_=[0,_rp_,[7,next_byte(0)]];
                return [0,Instruction_length[2],_rq_,_wJ_];
               ...
               case 246:
                var _wK_=[9,_rz_,[0,next_byte(0)]];
                return [0,Instruction_length[2],_rA_,_wK_];
               case 247:
                return [0,Instruction_length[1],_rB_,[32,RST_offset[7]]];
               case 248:
                var _wL_=[1,_rC_,[8,of_byte(next_byte(0))]];
                return [0,Instruction_length[2],_rD_,_wL_];
               case 249:return [0,Instruction_length[1],_rF_,_rE_];
               case 250:
                var _wM_=[0,_rG_,[2,next_word(0)]];
                return [0,Instruction_length[3],_rH_,_wM_];
               ...
               case 254:
                var _wN_=[11,_rL_,[0,next_byte(0)]];
                return [0,Instruction_length[2],_rM_,_wN_];
               default:
            ...
            switch(_wO_)
             {case 192:return [0,Instruction_length[1],_il_,_ik_];
              ...
              case 194:
               var _wq_=[29,1,[1,next_word(0)]];
               return [0,Instruction_length[3],_io_,_wq_];
              case 195:
               var _wr_=[29,0,[1,next_word(0)]];
               return [0,Instruction_length[3],_ip_,_wr_];
              case 196:
               var _ws_=[31,1,next_word(0)];
               return [0,Instruction_length[3],_iq_,_ws_];
              case 197:return [0,Instruction_length[1],_is_,_ir_];
              case 198:
               var _wt_=[2,_it_,[0,next_byte(0)]];
               return [0,Instruction_length[2],_iu_,_wt_];
              case 199:
              ...
              case 202:
               var _wu_=[29,2,[1,next_word(0)]];
               return [0,Instruction_length[3],_iA_,_wu_];
              case 203:
              ...
              case 204:
               var _wv_=[31,2,next_word(0)];
               return [0,Instruction_length[3],_qC_,_wv_];
              case 205:
               var _ww_=[31,0,next_word(0)];
               return [0,Instruction_length[3],_qD_,_ww_];
              case 206:
               var _wx_=[5,_qE_,[0,next_byte(0)]];
               return [0,Instruction_length[2],_qF_,_wx_];
              case 207:
              ...
              case 210:
               var _wy_=[29,3,[1,next_word(0)]];
               return [0,Instruction_length[3],_qL_,_wy_];
              case 211:return [0,Instruction_length[1],_qM_,4];
              case 212:
               var _wz_=[31,3,next_word(0)];
               return [0,Instruction_length[3],_qN_,_wz_];
              case 213:return [0,Instruction_length[1],_qP_,_qO_];
              case 214:
               var _wA_=[6,_qQ_,[0,next_byte(0)]];
               return [0,Instruction_length[2],_qR_,_wA_];
              case 215:
              ...
              case 218:
               var _wB_=[29,4,[1,next_word(0)]];
               return [0,Instruction_length[3],_qW_,_wB_];
              case 219:return [0,Instruction_length[1],_qX_,4];
              case 220:
               var _wC_=[31,4,next_word(0)];
               return [0,Instruction_length[3],_qY_,_wC_];
              case 221:return [0,Instruction_length[1],_qZ_,4];
              case 222:
               var _wD_=[7,_q0_,[0,next_byte(0)]];
               return [0,Instruction_length[2],_q1_,_wD_];
        ...
        if(32 <= _wO_)
         switch(_wO_)
          {case 32:
            var _wg_=[30,1,of_byte(next_byte(0))];
            return [0,Instruction_length[2],_du_,_wg_];
           case 33:
            var _wh_=[1,_dv_,[1,next_word(0)]];
            return [0,Instruction_length[3],_dw_,_wh_];
           ...
           case 38:
            var _wi_=[0,_dF_,[0,next_byte(0)]];
            return [0,Instruction_length[2],_dG_,_wi_];
           case 39:return [0,Instruction_length[1],_dH_,0];
           case 40:
            var _wj_=[30,2,of_byte(next_byte(0))];
            return [0,Instruction_length[2],_dI_,_wj_];
           ...
           case 46:
            var _wk_=[0,_dT_,[0,next_byte(0)]];
            return [0,Instruction_length[2],_dU_,_wk_];
           case 47:return [0,Instruction_length[1],_dV_,1];
           case 48:
            var _wl_=[30,3,of_byte(next_byte(0))];
            return [0,Instruction_length[2],_dW_,_wl_];
           case 49:
            var _wm_=[1,3,[1,next_word(0)]];
            return [0,Instruction_length[3],_dX_,_wm_];
           ...
           case 54:
            var _wn_=[0,_d6_,[0,next_byte(0)]];
            return [0,Instruction_length[2],_d7_,_wn_];
           case 55:return [0,Instruction_length[1],_d8_,3];
           case 56:
            var _wo_=[30,4,of_byte(next_byte(0))];
            return [0,Instruction_length[2],_d9_,_wo_];
           ...
           case 62:
            var _wp_=[0,_ei_,[0,next_byte(0)]];
            return [0,Instruction_length[2],_ej_,_wp_];
           default:return [0,Instruction_length[1],_ek_,2]}
        switch(_wO_)
         {case 0:return [0,Instruction_length[1],_cC_,4];
          case 1:
           var _v__=[1,_cD_,[1,next_word(0)]];
           return [0,Instruction_length[3],_cE_,_v__];
          ...
          case 6:
           var _v$_=[0,_cN_,[0,next_byte(0)]];
           return [0,Instruction_length[2],_cO_,_v$_];
          case 7:return [0,Instruction_length[1],_cP_,9];
          case 8:
           var _wa_=[1,[3,next_word(0)],3];
           return [0,Instruction_length[3],_cQ_,_wa_];
          ...
          case 14:
           var _wb_=[0,_c1_,[0,next_byte(0)]];
           return [0,Instruction_length[2],_c2_,_wb_];
          case 15:return [0,Instruction_length[1],_c3_,11];
          case 16:next_byte(0);return [0,Instruction_length[2],_c4_,6];
          case 17:
           var _wc_=[1,_c5_,[1,next_word(0)]];
           return [0,Instruction_length[3],_c6_,_wc_];
          ...
          case 22:
           var _wd_=[0,_dd_,[0,next_byte(0)]];
           return [0,Instruction_length[2],_de_,_wd_];
          case 23:return [0,Instruction_length[1],_df_,10];
          case 24:
           var _we_=[30,0,of_byte(next_byte(0))];
           return [0,Instruction_length[2],_dg_,_we_];
          ...
          case 30:
           var _wf_=[0,_dr_,[0,next_byte(0)]];
           return [0,Instruction_length[2],_ds_,_wf_];
          default:return [0,Instruction_length[1],_dt_,12]}}
      return [0,RST_offset,Instruction_length,f]}
    function _rO_(_v9_){return [0,Make(_v9_)[3]]}
    ...
    function zero_bank_num(t)
     {var _v8_=t[3];
      if(t[8])
       {if(32 < _v8_)
         {if(64 === _v8_)return (t[7] & 1) << 5;
          if(128 === _v8_)return (t[7] & 3) << 5;
    ...
    function ram_addr_of_addr(t,addr)
     {var _v7_=t[4];
      if(t[8] && 1 !== _v7_)
       {if(4 === _v7_)return (8192 * t[7] | 0) + (addr - 40960 | 0) | 0;
        throw [0,Invalid_argument,caml_call1(sprintf(_rU_),_v7_)]}
     ...
     {var addr$0=_b1_(addr);
      if(0 <= addr$0 && ! (16383 < addr$0))
       {var
         ...
         _vU_=(16384 * zero_bank_num$0 | 0) + addr$0 | 0,
         _vV_=t[1],
      ...
      if(16384 <= addr$0 && ! (32767 < addr$0))
       {var
         ...
         _vR_=(16384 * high_bank_num$0 | 0) + (addr$0 - 16384 | 0) | 0,
         _vS_=t[1],
         _vT_=function(_v3_,_v2_){return caml_ba_get_1(_v3_,_v2_)};
        return of_char(function(_v1_){return _vT_(_vS_,_v1_)}(_vR_))}
      if(40960 <= addr$0 && ! (49151 < addr$0))
       {if(t[5] && 0 < t[4])
         {var
           _vO_=function(_v0_){return ram_addr_of_addr(t,_v0_)}(addr$0),
           _vP_=t[2],
           _vQ_=function(_vZ_,_vY_){return caml_ba_get_1(_vZ_,_vY_)};
          return of_char(function(_vX_){return _vQ_(_vP_,_vX_)}(_vO_))}
        return of_int(255)}
     ...
     {var addr$0=_b1_(addr),data$0=_b2_(data);
      ...
      if(8192 <= addr$0 && ! (16383 < addr$0))
       {var
         ...
         _vM_=0 === rom_bank_num?1:rom_bank_num;
        t[6] = _vM_;
        return 0}
      if(16384 <= addr$0 && ! (24575 < addr$0)){t[7] = data$0 & 3;return 0}
      if(24576 <= addr$0 && ! (32767 < addr$0))
       {var _vL_=0 === (data$0 & 1)?0:1;t[8] = _vL_;return 0}
      if(40960 <= addr$0 && ! (49151 < addr$0))
       {var _vI_=t[5],_vJ_=_vI_?0 < t[4]?1:0:_vI_;
        if(_vJ_)
         var
          ram_addr=function(_vN_){return ram_addr_of_addr(t,_vN_)}(addr$0),
          _vK_=caml_ba_set_1(t[2],ram_addr,data$0);
        else
         var _vK_=_vJ_;
        return _vK_}
    ...
    function accepts$14(param,addr)
     {var
       addr$0=_b1_(addr),
       _vE_=0 <= addr$0?1:0,
       _vF_=_vE_?addr$0 <= 32767?1:0:_vE_;
      if(_vF_)
       var _vG_=_vF_;
      else
       var _vH_=40960 <= addr$0?1:0,_vG_=_vH_?addr$0 <= 49151?1:0:_vH_;
      return _vG_}
    ...
    function write_byte$15(param,_vD_,_vC_){return 0}
    function accepts$15(param,addr)
     {var
       addr$0=_b1_(addr),
       _vA_=0 <= addr$0?1:0,
       _vB_=_vA_?addr$0 <= 32767?1:0:_vA_;
      return _vB_}
